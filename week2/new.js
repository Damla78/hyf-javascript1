...
console.log("I expect in the array: blowfish, meerkat, capricorn, giraffe, turtle");
console.log(favoriteAnimals);
...
function vehicleType3(color, type, ageVehicle) {
  let str = 'a ' + color;
...
function addPlural(word) {
  ...
  beforeLastLetter = word.charAt(word.length - 2);
  //ends in s,ch,sh,x or z
  if (lastLetter == "s" || lastLetter == "x" || lastLetter == "z" || ((beforeLastLetter == 'c' || beforeLastLetter == 's') && lastLetter == 'h'))
    word += 'es';

  else if (lastLetter == 'f')//ends in f (leaf)
    word = word.substring(0, word.length - 1) + 'ves';
  else if (beforeLastLetter == 'f' && lastLetter == 'e')//ends with fe (life)
    word = word.substring(0, word.length - 2) + 'ves';
  else if (lastLetter == 'y' && !(beforeLastLetter == 'a' || beforeLastLetter == 'e' ||
    beforeLastLetter == 'i' || beforeLastLetter == 'o' || beforeLastLetter == 'u'))//ends in constant + y (city-cities)
    word = word.substring(0, word.length - 1) + 'ies';
  else if (lastLetter == 'o' && !(beforeLastLetter == 'a' || beforeLastLetter == 'e' ||
    beforeLastLetter == 'i' || beforeLastLetter == 'o' || beforeLastLetter == 'u'))//ends in constant and o (hero - heroes)
    word += 'es';
  else
    word += 's';
